		...
		images: [
			{
				...
				width: 1200,
				height: 630,
				alt: `${SITE_CONFIG.name} - ${totalCount} Free Financial Calculators`,
			},
		],
	},
	twitter: {
	...
	return (
		<div className="max-w-7xl mx-auto px-4 py-6 md:py-12">
			...
			<section className="text-center py-8 md:py-20">
				<h1 className="text-5xl font-bold mb-4 bg-gradient-to-r from-green-600 to-green-800 bg-clip-text text-transparent">
					{SITE_CONFIG.tagline}
				</h1>
				<p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
					Calculate interest, returns, and financial outcomes instantly with our
					free online calculators. No sign-up required.
				</p>
			</section>
			...
			{getCategoriesByOrder().map((category) => (
				<section key={category.id} className="mb-16">
					<Link href={category.url}>
						<h2 className="text-3xl font-bold mb-6 hover:text-green-600 dark:hover:text-green-400 transition-colors cursor-pointer">
							{category.label}
						</h2>
					</Link>
