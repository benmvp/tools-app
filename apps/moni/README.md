...
Moni is part of a **pnpm monorepo** managed by Turborepo:
...
Moni has comprehensive test coverage:
...
Moni has comprehensive end-to-end testing, accessibility compliance, and performance monitoring.
