...
import { ALL_ENCODERS } from "@/lib/tools-data";
import { getAppUrl, getOgImageUrl } from "@/lib/utils";

const ogImageUrl = getOgImageUrl(
  `${ALL_ENCODERS.length} Encoders & Decoders`,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `Codemata - ${ALL_ENCODERS.length} Encoders & Decoders`,
      },
    ],
  },
  twitter: {
    ...
    <div className="max-w-7xl mx-auto px-4 py-6 md:py-12">
      ...
      <section className="text-center py-8 md:py-12 mb-12">
        ...
        <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
          Encode and decode data instantly. Choose from {ALL_ENCODERS.length}{" "}
          different encoders and decoders for Base64, URL, HTML entities,
          JavaScript strings, and JWT tokens.
        </p>
      </section>
      {/* Tools Grid */}
      <section>
