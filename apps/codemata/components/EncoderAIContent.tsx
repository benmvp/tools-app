...
import { getAllAvailableTools, getEncoderContent } from "@/lib/ai/helpers";

interface EncoderAIContentProps {
  slug: string;
  encoderName: string;
}

/**
 * AI-generated content for encoder pages
 * This component is wrapped in Suspense for better loading UX
 */
export async function EncoderAIContent({
  slug,
  encoderName,
}: EncoderAIContentProps) {
